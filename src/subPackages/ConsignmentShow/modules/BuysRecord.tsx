 ...
 */
const GoodsDetail = () => {
  const { buysRecordList } = useSelector((state) => state.ConsignmentShow);
  ...
  const handleClose = () => {
    dispatch({ type: 'ConsignmentShow/updateIsShowBuysPaget', payload: false });
  };
  const onScrollToLower = (e) =>{
    dispatch({type:'ConsignmentShow/getPageBuysRecord'});
  }
